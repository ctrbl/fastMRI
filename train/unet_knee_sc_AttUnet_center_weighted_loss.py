...
from fastmri.pl_modules import AttUnetModuleCenterWeighted
...
def cli_main(args):
    ...
    data_module = FastMriDataModule(
        ...
        volume_sample_rate=args.sample_rate,
        val_volume_sample_rate=args.val_sample_rate,
    ...
    # model
    # ------------
    model = AttUnetModuleCenterWeighted(
...
def build_args():
    ...
    # basic args
    path_config = pathlib.Path("/content/drive/MyDrive/fastMRI/fastmri_dirs.yaml")
    backend = "cuda"
    num_gpus = 1
    batch_size = 1
    ...
    default_root_dir = (
        fetch_dir("log_path", path_config) / "unet" / "knee_sc_leaderboard_AttUnet_center_weighted_loss"
    )
