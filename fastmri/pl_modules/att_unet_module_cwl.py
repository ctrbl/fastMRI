...
from fastmri.models import AttUnet

from fastmri.losses import CenterWeightedL1Loss

from .mri_module import MriModule


class AttUnetModuleCenterWeighted(MriModule):
    """
    ...
    def training_step(self, batch, batch_idx):
        ...
        #print(output.shape)
        loss_function = CenterWeightedL1Loss()
